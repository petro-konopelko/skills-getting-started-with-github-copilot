...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop shooting, defense, and game strategy in a competitive setting",
    ...
    "Robotics Club": {
        "description": "Design, build, and program robots for fun challenges and competitions",
